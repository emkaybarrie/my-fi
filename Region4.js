...
// Update Array Lists 
   ...
   // Sector Lists
   var s0 = [this.illuviumForest(this)]
   // Sector Root Array
   sectors = [s0]
    ...
    illuviumForest(game){
        // Outputs a Stage Data Object Instance encoded with this stages parameters 
            ...
            // Stage Code
               ...
               var stage = stage.setName('illuviumForest')
               ...
               stage.data.set('id','4-0-0-0')
               stage.data.set('stageName','Illuvium Forest')
