class Region3 extends Phaser.Scene {
    ...
    // Global Data
        ...
        // Region 
            var regionID = 3
            var region = 'West'
            var regionPatron = 'Amara'
            var regionAffinity = 'Stocks'
    ...
    cliffsOfAmara(game){
        // Outputs a Stage Data Object Instance encoded with this stages parameters 
            ...
            // Stage Code
               ...
               var stage = stage.setName('cliffsOfAmara')
               ...
               stage.data.set('stageName','Cliffs of Amara')
               ...
               var stageAssetName = 'dawn'
               var stageBackgroundLayers = 8
