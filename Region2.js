...
class Region2 extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        // Sector Lists
        this.zone0 = [this.mundoDesert]
        this.zone1 = [this.mundoDesert]
        this.zone2 = [this.barrenPlains]
        this.zone3 = [this.barrenPlains]
        // Sector Root Array
        this.zones = [
    ...
    mundoDesert(game){
        ...
        // Writes Stage Data to Region Scene Data 
            ...
            // Stage Code
               ...
               game.stageFGScrollSpeedModifierSettings = [1.2]
    ...
    barrenPlains(game){
        ...
        // Writes Stage Data to Region Scene Data 
            ...
            // Stage Code
               ...
               game.stageBGScrollSpeedModifierSettings = [1,0.85,0.5,0.1,0]
