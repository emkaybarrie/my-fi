class Region2 extends Phaser.Scene {
    ...
    // Global Data
        ...
        // Region 
            var regionID = 2
            var region = 'North'
            var regionPatron = 'Lucarus'
            var regionAffinity = 'Property'
...
// Update Array Lists 
   ...
   // Sector Lists
   var s0 = [this.lucarianDesert(this),this.barrenPlains(this)]
   // Sector Root Array
   sectors = [s0]
    ...
    lucarianDesert(game){
        // Outputs a Stage Data Object Instance encoded with this stages parameters 
            ...
            // Stage Code
               ...
               var stage = stage.setName('lucarianDesert')
               ...
               stage.data.set('id','2-0-0-0')
               stage.data.set('stageName','Lucarian Desert')
               ...
               var stageAssetName = 'desert'
               var stageBackgroundLayers = 4
               var stageForegroundLayers = 0
               var stageBGScrollSpeedModifierSettings = [1,0.85,0.5,0]
    ...
    barrenPlains(game){
        // Outputs a Stage Data Object Instance encoded with this stages parameters 
            ...
            // Stage Code
               ...
               // Create Stage Data Object and Set Stage Object Name
               var stage = game.add.container()
               var stage = stage.setName('barrenPlains')
               ...
               stage.data.set('stageName','The Barren Plains')
               ...
               // Set Background (BG) & Foregorund (FG) Layers
               var stageAssetName = 'wasteland'
               var stageBackgroundLayers = 5
               var stageForegroundLayers = 0
               var stageBGScrollSpeedModifierSettings = [1,0.75,0.5,0.1,0]
               var stageFGScrollSpeedModifierSettings = []
               var stageNormalMaps = [0,0,0,0]
               // Create Data Entry for Number of Layers
                stage.data.set('stageAssetName',stageAssetName)
            ...
            stage.data.set('floorPosYMin', 0.025)
            stage.data.set('floorPosYMax', 0.075)
